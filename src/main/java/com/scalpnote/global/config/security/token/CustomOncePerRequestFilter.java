package com.scalpnote.global.config.security.token;

import com.scalpnote.domain.auth.application.CustomTokenProviderService;
...
//            Long userId = customTokenProviderService.getUserIdFromToken(jwt);
